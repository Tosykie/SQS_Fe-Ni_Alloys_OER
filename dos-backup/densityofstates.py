...
if __name__ == '__main__':
    path = r"."
#    dos1 = DensityOfStates(path)
#    dosdata = dos.generate_dos_dict(sites_spdf={'6': ['d'], '22':['d'], '65':['p']})
#    dosdata1 = dos1.generate_dos_dict(elements_spdf={'O':'p','Ni':'d','Fe':'d'})
...
#    dos1.dos_poltter(dosdata1, fig='dos', font='Arial', xlim=[-8, 6])  # 输出态密度图像
    
    dos = DensityOfStates(path)
    dosdata = dos.generate_dos_dict(sites_spdf={'69':'p','64':'d'})
    dos.dos_poltter(dosdata, fig='dos_active_site', font='Arial', xlim=[-8, 6])
